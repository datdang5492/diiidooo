                                        ...
                                        <b-form-group>
                                            ...
                                            >
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                            <span
                                                                class="text-danger">{{errors.first('flightFrom')}}</span>
                                                    </div>
                                                </div>
                                            </b-form-group>
                                            ...
                                            <b-form-group
                                                ...
                                                label-for="flight_to"
                                            >
                                                <b-form-input id="flight_to" name="flightTo"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                            <span
                                                                class="text-danger">{{errors.first('flightTo')}}</span>
                                                    </div>
                                                </div>
                                            </b-form-group>
...
<script>
    ...
    export default {
        ...
        mounted() {
            $(this.$refs.tabid).on("changed", this.test)
        },
        methods: {
            updateRoute() {
